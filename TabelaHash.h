...
//funcao que cria uma tabela hash
...
//funcao que libera toda uma tabela hash
...
//==============================================
int insereHash_SemColisao(Hash* ha, struct no al){
...
//busca um determinado valor na tabela 
int buscaHash_SemColisao(Hash* ha, int mat, struct no* al){
    if(ha == NULL)
        return 0;
...
//busca um determinado valor na tabela e printa se o valor for encontrado
int Busca_e_printa(Hash* ha, int mat, struct no* al){
    if(ha == NULL)
        return 0;
...
int insereHash_EnderAberto(Hash* ha, struct no al){
    if(ha == NULL || ha->qtd == ha->TABLE_SIZE)
        return 0;
...
int buscaHash_EnderAberto(Hash* ha, int mat, struct no* al){
    if(ha == NULL)
        return 0;
